...
/// </summary>
public sealed class OpcionesRhManager
{
    /// <summary>Nombre de la seccion en appsettings.json.</summary>
    public const string Seccion = "RhManager";
    ...
    /// <summary>Cadena de conexion a MySQL. Se asigna aparte, desde ConnectionStrings:RhManager.</summary>
